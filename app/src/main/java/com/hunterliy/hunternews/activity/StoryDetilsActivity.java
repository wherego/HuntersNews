...
import com.hunterliy.library.utils.Utils;
...
public class StoryDetilsActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        toolbar.setTitle(Utils.decodeUrlParam(getIntent().getStringExtra("title")));
        ...
        AppObservable.bindActivity(StoryDetilsActivity.this, ZhihuApi.http.getNewsDetail(getIntent().getStringExtra("id"))).subscribe(new Action1<NewsDetailResponse>() {
            @Override
            public void call(NewsDetailResponse newsDetailResponse) {
                collapsingToolbarLayout.setTitle(newsDetailResponse.getTitle());
