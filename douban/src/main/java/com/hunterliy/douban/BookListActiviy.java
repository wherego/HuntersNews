...
public class BookListActiviy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new BookAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View v, int position) {
                Toast.makeText(BookListActiviy.this, "eeeeeee", Toast.LENGTH_SHORT).show();
            }
        });
        getBooksList();
    }
    ...
    public void getBooksList() {
        ...
        params.put("end", "50");
        if (page==0) {
            AppObservable.bindActivity(this, DoubanApi.http.getBooks(params)).subscribe(new Action1<BookResponse>() {
                @Override
